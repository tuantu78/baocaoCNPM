...
window.onload = function () {
    ...
    var tags = ["Samsung", "iPhone", "Realme", "Oppo", "Mobi"];
...
function getDetailPromo(sp) {
    switch (sp.promo.name) {
        ...
        default:
            var span = `<span style="font-weight: bold">01 xe Mercedes C300 AMG</span>`;
