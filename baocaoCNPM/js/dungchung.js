	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a href="https://www.facebook.com/sweet.tie78"><i class="fa fa-facebook"></i></a>
                <a href="https://www.instagram.com/sweet.t_78/"><i class="fa fa-instagram"></i></a>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo1.jpg " alt="Trang chủ" title="Trang chủ">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="https://www.facebook.com/sweet.tie78">Sinh Viên: Nguyễn Tuấn Tú</a></p>
        <p>MSSV: 19810310120 - Khoa: Công nghệ thông tin - Chuyên ngành: Công nghệ phần mềm</p>
        <p><a href="https://www.epu.edu.vn/"> Electric Power University </a>
            <span style="color: #eee; font-weight: bold">(EPU)</span></p>
